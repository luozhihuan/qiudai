...
public class DormiBuildingActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listview_dormibuilding_select.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				/** 跳转Activity **/
//				CommonUtil.intentStartActivityLeftToRightWithFinish(DormiBuildingActivity.this, InputDormitoryNumberActivity.class);
				ActivitySkipHelperUtil.skipCurActivityToNewActivitySideToSide(DormiBuildingActivity.this, InputDormitoryNumberActivity.class, ActivitySkipHelperUtil.LEFT_TO_RIGHT);
