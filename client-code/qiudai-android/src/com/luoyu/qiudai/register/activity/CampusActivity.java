...
public class CampusActivity extends Activity implements OnClickListener {
...
//						CommonUtil.intentStartActivityLeftToRightWithFinish(CampusActivity.this, DormiBuildingActivity.class);
						...
						ActivitySkipHelperUtil.skipCurActivityToNewActivitySideToSide(CampusActivity.this, DormiBuildingActivity.class, ActivitySkipHelperUtil.LEFT_TO_RIGHT);
					}
